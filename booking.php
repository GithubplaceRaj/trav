...
<body>
     ...
     <div class="profile-container">
        <div class="box-1-dp">
            <img src="profile.png" class="my-profile-png"/>
        </div>
        <div class="box-1">
...
<div class="collection-of-booking-container">
    <div class="box-container-collection">
        <img src="hotel2.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">hotel booking</h3>
    </div>
    <div class="box-container-collection">
        <img src="guest.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Guest House Booking</h3>
    </div>
    <div class="box-container-collection">
        <img src="vila.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Villa Rental</h3>
    </div>
   
    <div class="box-container-collection">
        <img src="resorts.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Resorts Booking</h3>
    </div>
    <div class="box-container-collection">
        <img src="tour1.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Travel Portal Development</h3>
    </div>
    <div class="box-container-collection">
        <img src="car1.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Car Rental Solution</h3>
    </div>
    <div class="box-container-collection">
        <img src="safari1.png" width="150px" class="img-collection-png"/>
        <h3 class="img-collection-tittle">Safari Booking</h3>
    </div>
    <div class="box-container-collection">
        <img src="xml1.png" width="150px" class="img-collection-png"/>
